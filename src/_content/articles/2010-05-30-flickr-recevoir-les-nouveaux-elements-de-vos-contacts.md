...
<p><!--more--></p>
<ol>
<li>Une fois connecté sur Flickr, rendez-vous sur <a title="Page de gestion de votre compte" href="http://www.flickr.com/account/">la page de gestion de votre compte</a>.<br />
...
<li>Rendez-vous dans l'onglet « <a title="Onglet Emails et notifications" href="http://www.flickr.com/account/?tab=email">Emails et notifications</a> »<br />
...
<li>Vérifier que l'« Email pour vos contacts » est une adresse que vous utilisez (ou celle sur laquelle vous voulez recevoir les notifications). Le cas échéant, <a title="Modifiez son adresse mail" href="http://www.flickr.com/account/prefs/email/?from=email">modifiez-la</a>.<br />
...
<li>La rubrique « Mails d'activités récentes » comporte deux options que <a title="Modifier les réglages concernant l'activité" href="http://www.flickr.com/account/prefs/email/activity/?from=email">vous pouvez modifier</a>. Par défaut, tout est désactivé :
<ol>
